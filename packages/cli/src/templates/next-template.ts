...
export const metadata = {
  title: 'NL Framework + Next',
  description: 'Next.js frontend generated by the NL Framework CLI',
};
...
export default function Home() {
  return (
    <main style={{ fontFamily: 'Inter, system-ui, sans-serif', padding: '2rem' }}>
      ...
      <h1 style={{ fontSize: '2.25rem', margin: '0.25rem 0 0.75rem' }}>NL Framework + Next.js</h1>
      <p style={{ color: '#475569', maxWidth: '42rem', lineHeight: 1.6 }}>
        This Next.js app was generated alongside your NL Framework backend. Wire it to your API under
