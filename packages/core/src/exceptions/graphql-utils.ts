 ...
 */
export const ERROR_CODE_TO_GRAPHQL_CODE: Record<string, string> = {
 ...
 */
export function getGraphQLCodeFromException(exception: ApplicationException): string {
 ...
 */
export function toGraphQLError(exception: ApplicationException): GraphQLError {
