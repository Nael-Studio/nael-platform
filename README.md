...
- [x] Bun-native CLI for bootstrapping new services (`nl new <project-name>`), feature modules (`nl g module <module-name>`), and shared libraries (`nl g lib <lib-name>`) with ready-to-run Nael scaffolding
