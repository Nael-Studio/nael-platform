...
<div className="space-y-16">
    ...
    <Card className="border-border/70">
      <CardContent className="space-y-3 py-6 text-muted-foreground">
        ...
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li>Unified HTTP, GraphQL, federation gateway, and microservices factories via `NLFactory`.</li>
  ...
  <section className="space-y-6" id="graphql">
    ...
    <div className="text-muted-foreground">
      Schema-first development with Apollo Server under the hood. Run a gateway and subgraphs from the same NLFactory instance or deploy them independently.
    </div>
