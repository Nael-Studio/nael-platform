---
title: 'Overview · Nael Framework'
description: 'Learn about Nael Framework philosophy, installation options, Better Auth integration, GraphQL, and microservices support.'
---
...
<div className="space-y-16">
  <section className="space-y-4" id="introduction">
    ...
    <div className="space-y-3">
      ...
      <h1 className="text-4xl font-semibold tracking-tight">Nael Framework Overview</h1>
    ...
    <div className="grid gap-4 md:grid-cols-2">
      ...
      <Card className="border-border/70">
        ...
        <CardContent className="space-y-3 text-sm text-muted-foreground">
          <div>We highlight ecosystem partners building on Nael (hosting, observability, dashboards).</div>
