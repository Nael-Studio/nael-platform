...
export const controllerUsage = `import { UseInterceptors } from '@nl-framework/core';
...
export const functionalInterceptor = `import { UseInterceptors } from '@nl-framework/core';
import { InterceptorFunction } from '@nl-framework/http';
...
<article className="space-y-8">
      ...
      <Card className="border-purple-200 bg-purple-50 dark:border-purple-900/50 dark:bg-purple-950">
        <CardContent className="pt-6 text-sm text-purple-900 dark:text-purple-50">
          ...
          <div className="mt-3">
            Import <code>UseInterceptors</code> from <code>@nl-framework/core</code> so the same decorator applies to HTTP, GraphQL,
            and microservice handlers without extra adapter shims.
          </div>
        </CardContent>
      </Card>
