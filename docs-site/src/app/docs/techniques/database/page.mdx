---
title: 'Database techniques · NL Framework'
description: 'Wire relational or document databases into NL Framework applications using DI-friendly modules and configuration.'
---
...
export const connectionSnippet = `import { Module } from '@nl-framework/core';
...
export const repositorySnippet = `import { Inject, Injectable, Scope } from '@nl-framework/core';
...
export const transactionsSnippet = `import { Inject, Injectable } from '@nl-framework/core';
...
<article className="space-y-8">
      <div className="space-y-3">
        ...
        <div className="text-lg text-muted-foreground">
          Databases sit at the heart of most NL Framework applications. Whether you use raw drivers, query builders, or the first-class NL Framework ORM, the goal is
      ...
      <section className="space-y-4" id="repositories">
        ...
        <div className="text-muted-foreground">
          Mark repositories as `Scope.REQUEST` when they need access to scoped metadata (tenant, auth context) or transactional state. Using
      ...
      <section className="space-y-4" id="transactions">
        ...
        <div className="text-muted-foreground">
          ...
          jobs. Always release connections inside `finally` blocks and surface errors through domain exceptions.
        </div>
        <CodeBlock code={transactionsSnippet} title="Transactional service" />
      </section>

      <section className="space-y-4" id="orm">
        <h2 className="text-2xl font-semibold">Looking for the NL Framework ORM?</h2>
        <div className="text-muted-foreground">
          NL Framework ships an opinionated ORM with schema migrations, repositories, and multi-tenant helpers. This page covers low-level integration using raw
