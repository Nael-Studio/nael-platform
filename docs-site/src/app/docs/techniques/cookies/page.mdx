...
description: 'Read and write HTTP cookies safely in NL Framework apps, including multi-tenant prefixes with Better Auth.'
---
...
<article className="space-y-8">
      <div className="space-y-3">
        ...
        <div className="text-lg text-muted-foreground">
          Use the native `Request`/`Response` APIs to manage cookies in NL Framework HTTP handlers. Parse
