...
description: 'Configure the NL Framework HTTP module, global middleware, and request pipeline behaviors.'
---
...
export const bootstrap = `import { NL FrameworkFactory } from '@nl-framework/platform';
...
<article className="space-y-8">
  <div className="space-y-3">
    ...
    <div className="text-lg text-muted-foreground">
      Configure the NL Framework HTTP module to serve controllers, middleware, and global pipeline hooks. Apply CORS/helmet,
