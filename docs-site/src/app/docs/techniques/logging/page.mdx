...
export const configureLogger = `import { NL FrameworkFactory } from '@nl-framework/platform';
...
const app = await NL FrameworkFactory.create(AppModule, { logger: appLogger });
