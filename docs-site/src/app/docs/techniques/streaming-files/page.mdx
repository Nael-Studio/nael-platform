...
description: 'Stream files and large responses in NL Framework using Bun-native ReadableStreams, range requests, and headers.'
---
...
<article className="space-y-8">
  ...
  <section className="space-y-4" id="storage">
    ...
    <div className="text-muted-foreground">
      If you use the NL Framework StorageModule, ask the adapter for a streaming body (S3/Azure drivers expose readable
