...
export const httpSerialization = `import { Module, ConfigService, SerializeOptions, UseInterceptors } from '@nl-framework/core';
import { ConfigModule } from '@nl-framework/config';
import { Controller, Get, HttpSerializationInterceptor } from '@nl-framework/http';
...
export const graphqlSerialization = `import { Module, ConfigService, SerializeOptions, UseInterceptors } from '@nl-framework/core';
import { ConfigModule } from '@nl-framework/config';
...
<article className="space-y-8">
      <div className="space-y-3">
        ...
        <div className="text-lg text-muted-foreground">
          Shape your JSON responses with class-transformer. NL Framework provides a shared `serialize()` helper,
