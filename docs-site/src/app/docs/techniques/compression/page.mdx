...
description: 'Add response compression with HTTP middleware in NL Framework applications using Bun'
---
...
<article className="space-y-8">
      <div className="space-y-3">
        ...
        <div className="text-lg text-muted-foreground">
          Use HTTP middleware to gzip JSON responses when clients advertise support. NL Framework does not bundle a compressor by
