...
<article className="space-y-8">
      <div className="space-y-3">
        ...
        <div className="text-lg text-muted-foreground">
          Nael leans on `class-validator` and `class-transformer` to keep payloads predictable.
      ...
      <section className="space-y-4" id="dtos">
        ...
        <div className="text-muted-foreground">
          Decorate classes with validation rules and optional transformation hints. Nael calls `class-transformer`{' '}
