...
description: 'Implement cookie-backed sessions in Nael HTTP apps with signed IDs and pluggable stores.'
---
...
export const sessionMiddleware = `import { NaelFactory } from '@nl-framework/platform';
...
<article className="space-y-8">
  <div className="space-y-3">
    ...
    <div className="text-lg text-muted-foreground">
      Nael doesn&apos;t ship a session manager by default. Use signed, cookie-based session IDs and a pluggable store
