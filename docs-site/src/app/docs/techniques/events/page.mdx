...
description: 'Publish and handle domain events using the NL Framework microservices module and Dapr pub/sub.'
---
...
<article className="space-y-8">
      <div className="space-y-3">
        ...
        <div className="text-lg text-muted-foreground">
          Decouple services with domain events. NL Framework uses the microservices module with Dapr pub/sub by default, giving
