...
description: 'Handle multipart/form-data uploads in NL Framework HTTP handlers using native FormData APIs.'
---
...
// When bootstrapping Apollo/NL Framework GraphQL, ensure graphql-upload middleware is applied to the HTTP server.
...
<article className="space-y-8">
      <div className="space-y-3">
        ...
        <div className="text-lg text-muted-foreground">
          NL Framework doesn&apos;t bundle Multer or busboy. Instead, use the platform-native `Request.formData()` to
      ...
      <section className="space-y-4" id="graphql">
        ...
        <div className="text-muted-foreground">
          Use `graphql-upload` with the NL Framework GraphQL stack. Register the middleware on the HTTP server for multipart
