...
export const gatewayConfig = `NaelFactory.create(FederationGatewayModule.forRoot({
...
export const graphqlServer = `const app = await NaelFactory.create(GraphQLModule.forRoot({
