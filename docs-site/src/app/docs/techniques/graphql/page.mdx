...
export const gatewayConfig = `NLFactory.create(FederationGatewayModule.forRoot({
...
export const graphqlServer = `const app = await NLFactory.create(GraphQLModule.forRoot({
