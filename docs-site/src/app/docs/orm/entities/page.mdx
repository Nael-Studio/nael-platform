---
title: 'ORM documents · Nael Framework'
...
<article className="space-y-8">
      <div className="space-y-3">
        ...
        <div className="text-lg text-muted-foreground">
          Entities in the Nael ORM are simple classes annotated with `@Document()`. Metadata drives collection names, timestamps, soft-delete,
