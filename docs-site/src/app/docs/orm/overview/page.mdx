---
title: 'NL Framework ORM overview · NL Framework'
description: 'Install and register the NL Framework ORM, connect drivers, and expose connection tokens across your application.'
---
...
export const rootSnippet = `import { Module } from '@nl-framework/core';
...
export const asyncSnippet = `import { Module } from '@nl-framework/core';
...
export const tokensSnippet = `import { Inject, Injectable } from '@nl-framework/core';
...
<article className="space-y-8">
      <div className="space-y-3">
        ...
        <h1 className="text-4xl font-semibold tracking-tight">NL Framework ORM overview</h1>
        <div className="text-lg text-muted-foreground">
          The ORM package aligns with NL Framework's DI container: connections are registered through modules, repositories become injectable providers, and seed
      ...
      <section className="space-y-4" id="register">
        ...
        <div className="text-muted-foreground">
          Call `OrmModule.forRoot()` once per database. Provide a driver—Mongo ships today and additional drivers can be added by exporting the
          `OrmDriver` interface. Each connection receives a name (defaults to `default`) so repositories, seeds, and tokens know
      ...
      <section className="space-y-4" id="async">
        ...
        <div className="text-muted-foreground">
          Use `forRootAsync()` when URIs, credentials, or feature flags live in the <Link className="text-primary underline" href="/docs/techniques/configuration">configuration module</Link>, BetterAuth tenant resolvers, or secret stores.
      ...
      <section className="space-y-4" id="tokens">
        ...
        <div className="text-muted-foreground">
          ...
          `connectionName` so multi-database apps remain explicit.
        </div>
