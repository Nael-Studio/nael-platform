---
title: 'Injection scopes · NL Framework'
description: 'Understand singleton, request, and transient lifecycles in the NL Framework IoC container.'
---
...
<article className="space-y-8">
      ...
      <section className="space-y-4" id="request">
        ...
        <div className="text-sm text-muted-foreground">
          ...
          consuming provider as request-scoped, otherwise NL Framework will throw a circular scope error.
        </div>
      </section>
