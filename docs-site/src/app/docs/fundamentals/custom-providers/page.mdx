---
title: "Custom providers · NL Framework"
...
<article className="space-y-8">
      <div className="space-y-3">
        ...
        <div className="text-lg text-muted-foreground">
          Everything in NL Framework is just a provider resolved by a token. By shaping those tokens yourself—value objects, alternate classes, or factories—you
      ...
      <section className="space-y-4" id="tokens">
        ...
        <div className="text-muted-foreground">
          ...
          an instance—like a database client or preconfigured SDK—and want NL Framework&rsquo;s container to share it everywhere.
        </div>
      ...
      <section className="space-y-4" id="use-factory">
        ...
        <div className="text-muted-foreground">
          ...
          which makes them ideal for bootstrapping SDKs that need configuration, logging, or other providers. NL Framework will await the Promise before exposing
