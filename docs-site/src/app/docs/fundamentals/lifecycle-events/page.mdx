---
title: 'Lifecycle events · NL Framework'
description: 'Use OnModuleInit, OnModuleDestroy, and bootstrap hooks to manage resources cleanly in NL Framework modules.'
---
...
<article className="space-y-8">
      <div className="space-y-3">
        ...
        <div className="text-lg text-muted-foreground">
          Providers in NL Framework can perform setup and teardown logic through lifecycle interfaces. Knowing when these callbacks fire keeps long-lived
      ...
      <section className="space-y-4" id="tips">
        ...
        <ul className="list-disc pl-6 text-muted-foreground">
          <li>Keep lifecycle methods idempotent; NL Framework might instantiate providers more than once in transient or manual contexts.</li>
