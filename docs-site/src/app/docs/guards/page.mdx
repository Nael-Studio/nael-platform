...
export const authGuard = `import { CanActivate } from '@nl-framework/core';
import { HttpGuardExecutionContext } from '@nl-framework/http';
...
export const useGuardsMethod = `import { UseGuards } from '@nl-framework/core';
...
export const functionalGuards = `import { UseGuards } from '@nl-framework/core';
import { GuardFunction } from '@nl-framework/http';
...
export const rbacPattern = `import { Injectable, SetMetadata, UseGuards, type CanActivate } from '@nl-framework/core';
import { HttpGuardExecutionContext } from '@nl-framework/http';
...
<article className="space-y-8">
      ...
      <Card className="border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-950">
        <CardContent className="pt-6">
          ...
          <div className="mt-3 text-sm text-blue-900/90 dark:text-blue-100/90">
            Import <code>UseGuards</code> from <code>@nl-framework/core</code> so the same decorator works across HTTP, GraphQL,
            and microservices without transport-specific shims.
          </div>
        </CardContent>
      </Card>
        ...
        <div className="space-y-3">
          <Card className="border-border/70">
            <CardContent className="space-y-2 pt-6 text-sm text-muted-foreground">
              ...
              <div><strong>Order Matters:</strong> Apply guards in logical order: authentication → authorization → resource checks.</div>
