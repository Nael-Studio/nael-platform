...
description: 'Proxy hosted BetterAuth routes through NL Framework HTTP, share sessions, and support multi-tenant secrets.'
---
...
<article className="space-y-8">
  ...
  <section className="space-y-4" id="enrich">
    ...
    <div className="text-sm text-muted-foreground">
      How it reacts in NL Framework: <code>BetterAuthGuard</code> reads from <code>BetterAuthSessionStore</code> on every request,
