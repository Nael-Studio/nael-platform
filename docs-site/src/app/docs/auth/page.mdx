...
description: 'Install BetterAuth for NL Framework, proxy hosted routes, and share session context across transports.'
---
...
<article className="space-y-8">
  <div className="space-y-3">
    ...
    <h1 className="text-4xl font-semibold tracking-tight">BetterAuth in NL Framework</h1>
    <div className="text-lg text-muted-foreground max-w-3xl">
      NL Framework treats BetterAuth as a first-class identity provider. Proxy the hosted auth router, reuse the same session
  ...
  <section className="space-y-4" id="install">
    ...
    <div className="text-muted-foreground">
      Add the NL Framework auth module plus the BetterAuth SDK. Everything runs on Bun&apos;s native fetch implementation.
    </div>
  ...
  <section className="space-y-4" id="exports">
    ...
    <div className="text-muted-foreground">
      The NL Framework auth package wraps BetterAuth and exposes a small set of building blocks for both HTTP and GraphQL.
