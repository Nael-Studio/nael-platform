---
title: "Providers · Nael Framework"
description: "Learn about providers, dependency injection, and service management in Nael Framework."
---
...
<div className="space-y-10">
      ...
      <section className="space-y-4">
        ...
        <div className="text-sm text-muted-foreground">
          ...
          by the Nael IoC container. This example also uses a `User` interface, which probably looks something like this:
        </div>
      ...
      <section className="space-y-4">
        ...
        <div className="text-muted-foreground">
          ...
          In the example below, Nael will resolve the `usersService` by creating and returning an instance of `UsersService` (or,
      ...
      <section className="space-y-4">
        ...
        <div className="text-muted-foreground">
          The `useValue` syntax is useful for injecting a constant value, putting an external library into the Nael container,
