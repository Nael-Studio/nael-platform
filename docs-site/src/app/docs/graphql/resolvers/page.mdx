---
title: 'Resolvers · GraphQL'
description: 'Build resolvers in Nael GraphQL: queries, mutations, guards, and context patterns.'
---
...
export const guardExample = `import { UseGuards, CurrentSession, BetterAuthGuard, type BetterAuthSession } from '@nl-framework/auth';
