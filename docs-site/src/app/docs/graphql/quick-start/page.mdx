---
title: 'GraphQL quick start · GraphQL'
description: 'Bootstrap a Nael GraphQL server, wire schemas/resolvers, and secure it with BetterAuth.'
---
...
import { UseGuards, CurrentSession, BetterAuthGuard, BetterAuthSession } from '@nl-framework/auth';
...
<article className="space-y-8">
  <div className="space-y-3">
    ...
    <div className="text-lg text-muted-foreground max-w-3xl">
      Create a Nael GraphQL server with schema-first tooling, BetterAuth integration, and a sample resolver. This guide
