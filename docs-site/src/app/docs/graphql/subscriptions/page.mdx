...
description: 'Enable GraphQL subscriptions in Nael with graphql-ws, typed events, and BetterAuth-aware contexts.'
---
...
<article className="space-y-8">
  <div className="space-y-3">
    ...
    <div className="text-lg text-muted-foreground max-w-3xl">
      Enable realtime GraphQL with <code>graphql-ws</code>, typed payloads, and Nael DI-backed services. Reuse BetterAuth
