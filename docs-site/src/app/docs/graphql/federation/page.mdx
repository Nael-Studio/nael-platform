---
title: 'Federation · GraphQL'
description: 'Expose NL Framework GraphQL services as Apollo Federation subgraphs and gateways.'
---
...
export const gatewayNote = `// NL Framework ships subgraph support. For a gateway, compose subgraphs using Apollo Router/Supergraph tooling.
// Steps:
...
<article className="space-y-8">
  <div className="space-y-3">
    ...
    <div className="text-lg text-muted-foreground max-w-3xl">
      Turn a NL Framework GraphQL service into a Federation subgraph by enabling <code>federation</code> in
  ...
  <section className="space-y-4" id="gateway">
    ...
    <div className="text-muted-foreground">
      NL Framework covers subgraphs. For the gateway, compose subgraphs with Apollo Router/Supergraph tools. Point the router at
      your NL Framework subgraphs; they expose the federation SDL automatically when <code>federation</code> is enabled.
    </div>
