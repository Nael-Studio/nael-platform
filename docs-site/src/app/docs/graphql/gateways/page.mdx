...
export const gatewayOptions = `import { NLFactory } from '@nl-framework/platform';
...
<article className="space-y-8">
  <div className="space-y-3">
    ...
    <div className="text-lg text-muted-foreground max-w-3xl">
      NL Framework ships a built-in Apollo Federation gateway. Pass subgraph URLs to <code>NLFactory</code>, and it boots an
