...
description: 'Use GraphQL plugins in NL Framework to extend execution—logging, tracing, validation, and custom responses.'
---
...
<article className="space-y-8">
  <div className="space-y-3">
    ...
    <div className="text-lg text-muted-foreground max-w-3xl">
      Attach Apollo-style plugins to your NL Framework GraphQL server for logging, tracing, auth preloading, or custom response
      shaping.
    </div>
  </div>
