---
title: 'Getting Started · NL Framework'
description: 'Scaffold and run NL Framework services with the CLI or the monorepo examples.'
---
        ...
        <Card className="border-border/80">
          ...
          <CardContent className="space-y-3">
            <div className="text-sm text-muted-foreground">
              ...
              NL FrameworkFactory instance wired with logging and configuration.
            </div>
      ...
      <section className="space-y-4">
        ...
        <ul className="grid gap-3 md:grid-cols-2">
          <li className="rounded-2xl border border-border/70 bg-card p-4">
            <div className="font-medium"><code>NL FrameworkFactory</code> bootstrap</div>
            <div className="text-sm text-muted-foreground">
