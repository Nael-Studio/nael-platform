...
export const mainFile = `import { NLFactory } from '@nl-framework/core';
...
<div className="space-y-10">
      ...
      <section className="space-y-4">
        ...
        <ul className="list-disc space-y-2 pl-5 text-sm text-muted-foreground">
          <li><code>src/main.ts</code> - The entry file of the application which uses the core function <code>NLFactory</code> to create an application instance.</li>
      ...
      <section className="space-y-4">
        ...
        <div className="text-sm text-muted-foreground">
          To create a NL Framework application instance, we use the core `NLFactory` class. `NLFactory` exposes a few static methods
