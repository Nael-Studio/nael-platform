...
description: 'Define message and event patterns for Nael microservices using Dapr transport.'
---
...
<article className="space-y-8">
  ...
  <section className="space-y-4" id="declare">
    ...
    <div className="text-muted-foreground">
      Decorate consumer methods with patterns. Nael discovers handlers and logs them on startup.
    </div>
