...
export const guardDef = `import { CanActivate, UseGuards } from '@nl-framework/core';
...
export const consumer = `import { Injectable, UseGuards } from '@nl-framework/core';
...
export const betterAuthGuard = `import { BetterAuthMicroGuard } from '@nl-framework/microservices';
import { Injectable, UseGuards } from '@nl-framework/core';
import { MessagePattern } from '@nl-framework/microservices';
