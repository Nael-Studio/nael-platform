---
title: 'Microservices overview · Microservices'
description: 'Build Dapr-backed microservices in Nael with message patterns, transport clients, and DI-friendly consumers.'
---
...
<article className="space-y-8">
  <div className="space-y-3">
    ...
    <div className="text-lg text-muted-foreground max-w-3xl">
      Nael ships a Dapr-backed microservices module with request/response and pub/sub semantics. Use decorators to
