...
description: 'Use Dapr as the transport layer for NL Framework microservices: pub/sub, service invocation, and sidecar ergonomics.'
---
...
<article className="space-y-8">
  <div className="space-y-3">
    ...
    <div className="text-lg text-muted-foreground max-w-3xl">
      Dapr sidecars give NL Framework microservices a consistent transport for pub/sub and service invocation without pulling
