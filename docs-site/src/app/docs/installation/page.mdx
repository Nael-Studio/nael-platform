---
title: "Installation · NL Framework"
description: "Install NL Framework from the monorepo or by selectively adding @nl-framework packages to your Bun workspace."
---
...
export const workspaceSetup = `git clone git@github.com:NL Framework-Studio/nael-platform.git
cd nael-platform
bun install`;
...
<div className="space-y-10">
      <div className="space-y-3">
        ...
        <h1 className="text-4xl font-semibold">Install NL Framework</h1>
