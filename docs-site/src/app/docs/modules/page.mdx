---
title: 'Modules · NL Framework'
description: 'Learn how to organize your NL Framework application using modules for better code structure and reusability.'
---
...
<div className="space-y-10">
      <div className="space-y-3">
        ...
        <div className="max-w-2xl text-muted-foreground">
          A module is a class annotated with a <code>@Module()</code> decorator. The <code>@Module()</code> decorator provides metadata that NL Framework makes use of to organize the application structure. Each application has at least one module, a root module. The root module is the starting point NL Framework uses to build the application graph.
        </div>
      </div>
      ...
      <section className="space-y-4">
        ...
        <div className="text-muted-foreground">
          In NL Framework, modules are singletons by default, and thus you can share the same instance of any provider between multiple modules effortlessly. Every module is automatically a shared module. Once created it can be reused by any module. Let&apos;s imagine that we want to share an instance of the <code>ConfigService</code> between several other modules.
        </div>
      ...
      <section className="space-y-4">
        ...
        <ul className="list-disc space-y-2 pl-5 text-sm text-muted-foreground">
          <li>
            <code>providers</code> - the providers that will be instantiated by the NL Framework injector and that may be shared at least across this module
          </li>
          <li>
