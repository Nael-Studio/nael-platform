---
title: 'Controllers · NL Framework'
description: 'Learn how to create and use controllers to handle incoming requests in NL Framework.'
---
...
<div className="space-y-10">
      ...
      <section className="space-y-4">
        ...
        <div className="text-sm text-muted-foreground">
          The `@Get()` HTTP request method decorator before the `findAll()` method tells NL Framework to create a handler for
      ...
      <section className="space-y-4">
        ...
        <div className="text-muted-foreground">
          Handlers often need access to the client request details. NL Framework provides access to the request object. We can access the request object
          by instructing NL Framework to inject it by adding the `@Req()` decorator to the handler&apos;s signature.
        </div>
      ...
      <section className="space-y-4">
        ...
        <div className="text-sm text-muted-foreground">
          NL Framework provides decorators for all of the standard HTTP methods: `@Get()`, `@Post()`, `@Put()`, `@Delete()`, `@Patch()`, `@Options()`, and `@Head()`.
      ...
      <section className="space-y-4">
        ...
        <div className="text-muted-foreground">
          NL Framework supports async functions. Every async function has to return a `Promise`. This means that you can return a deferred value
          that NL Framework will be able to resolve by itself.
        </div>
        <CodeBlock code={asyncController} title="Async controller" />
        <div className="text-sm text-muted-foreground">
          Furthermore, NL Framework route handlers are even more powerful by being able to return Bun streams. NL Framework will automatically resolve the stream.
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div className="text-sm text-muted-foreground">
          With the above controller fully defined, NL Framework knows exactly how to map every route. Note that NL Framework employs dependency injection,
