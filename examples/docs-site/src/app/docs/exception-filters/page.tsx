...
const basicFilter = `import { ExceptionFilter, HttpException } from '@nl-framework/http';
...
const registerFilter = `import { registerExceptionFilters } from '@nl-framework/http';
import { HttpExceptionFilter } from './filters/http-exception.filter';

// Register during application bootstrap
registerExceptionFilters(new HttpExceptionFilter());`;

const httpException = `import { HttpException } from '@nl-framework/http';
...
const staticMethods = `import { HttpException } from '@nl-framework/http';
...
const validationFilter = `import { ExceptionFilter } from '@nl-framework/http';
...
const problemJsonFilter = `import { ExceptionFilter, HttpException } from '@nl-framework/http';
import type { RequestContext } from '@nl-framework/http';
...
const loggingFilter = `import { ExceptionFilter, HttpException } from '@nl-framework/http';
...
const multipleFilters = `import { registerExceptionFilters } from '@nl-framework/http';
...
const customException = `export class DatabaseException extends Error {
  constructor(
    message: string,
...
const catchAllFilter = `import { ExceptionFilter } from '@nl-framework/http';
import type { RequestContext } from '@nl-framework/http';
    ...
    <div className="space-y-10">
      ...
      <section className="space-y-4">
        ...
        <p className="text-muted-foreground">
          Exception filters implement the <code>ExceptionFilter</code> interface, which requires a single <code>catch()</code> method.
          This method receives the exception and the request context, and must return a <code>Response</code> object.
        </p>
      ...
      <section className="space-y-4">
        ...
        <p className="text-muted-foreground">
          Exception filters are registered globally using the <code>registerExceptionFilters()</code> function, typically during
      ...
      <section className="space-y-4">
        ...
        <p className="text-muted-foreground">
          The <code>HttpException</code> class provides a convenient way to throw HTTP errors with specific status codes.
        ...
        <p className="text-sm text-muted-foreground">
          Use <code>HttpException</code> in your controllers and services to indicate HTTP-level errors:
        </p>
      ...
      <section className="space-y-4">
        ...
        <p className="text-sm text-muted-foreground">
          Note that this filter re-throws the exception if it&apos;s not a <code>ValidationException</code>, allowing other
      ...
      <section className="space-y-4">
        ...
        <div className="rounded-lg border border-blue-500/50 bg-blue-500/10 p-4">
          <p className="text-sm text-blue-700 dark:text-blue-400">
            <strong>Tip:</strong> Register more specific filters first (like <code>ValidationExceptionFilter</code>),
      ...
      <section className="space-y-4">
        ...
        <ol className="list-decimal space-y-2 pl-5 text-sm text-muted-foreground">
          ...
          <li>
            If a filter returns a <code>Response</code>, that response is sent to the client
          </li>
