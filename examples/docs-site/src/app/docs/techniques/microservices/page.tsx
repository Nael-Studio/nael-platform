...
const installMicro = `bun add @nl-framework/microservices @nl-framework/scheduler dapr-client`;
const daprConsumer = `@Subscriber({
...
const schedulerExample = `@Cron("0 */5 * * * *", { name: "warm-cache" })
handleCacheWarmup() {
...
export default function MicroservicesTechniquePage() {
  return (
        ...
        <Card className="border-border/70">
          ...
          <CardContent className="space-y-3">
            <p className="text-sm text-muted-foreground">
              Decorate a class with <code>@Subscriber()</code> to automatically register handlers with the Dapr sidecar.
